...
#define PARAM_ADC_START_ON_EDGE_OPT(OPT)                                       \
  ((OPT == ADC_START_ON_RISING) || (OPT == ADC_START_ON_FALLING))

/** Check ADC state parameter */
#define PARAM_ADC_DATA_STATUS(OPT)                                             \
  ((OPT == ADC_DATA_BURST) || (OPT == ADC_DATA_DONE))
...
#define PARAM_ADC_CHANNEL_SELECTION(SEL)                                       \
  ((SEL == ADC_CHANNEL_0) || (ADC_CHANNEL_1) ||                                \
   (SEL == ADC_CHANNEL_2) | (ADC_CHANNEL_3) || (SEL == ADC_CHANNEL_4) ||       \
   (ADC_CHANNEL_5) || (SEL == ADC_CHANNEL_6) || (ADC_CHANNEL_7))
...
#define PARAM_ADC_TYPE_INT_OPT(OPT)                                            \
  ((OPT == ADC_ADINTEN0) || (OPT == ADC_ADINTEN1) || (OPT == ADC_ADINTEN2) ||  \
   (OPT == ADC_ADINTEN3) || (OPT == ADC_ADINTEN4) || (OPT == ADC_ADINTEN5) ||  \
   (OPT == ADC_ADINTEN6) || (OPT == ADC_ADINTEN7) || (OPT == ADC_ADGINTEN))
