...
#define I2C_I2MMCTRL_MATCH_ALL                                                 \
  ((1 << 2))                          /**< Select interrupt register match */
...
/*********************************************************************/ /**
                                                                         ...
                                                                         *defines
                                                                         **********************************************************************/
#define I2C_MONITOR_CFG_SCL_OUTPUT                                             \
  I2C_I2MMCTRL_ENA_SCL /**< SCL output enable */
#define I2C_MONITOR_CFG_MATCHALL                                               \
  I2C_I2MMCTRL_MATCH_ALL /**< Select interrupt register match */
...
#define PARAM_I2C_MONITOR_CFG(n)                                               \
  ((n == I2C_MONITOR_CFG_SCL_OUTPUT) || (I2C_MONITOR_CFG_MATCHALL))
...
typedef enum { I2C_0 = 0, I2C_1, I2C_2 } en_I2C_unitId;
...
typedef struct {
  ...
  uint8_t GeneralCallState; /**< Enable/Disable General Call Functionality
                            ...
                            */
  uint8_t
      SlaveAddrMaskValue; /**< Any bit in this 8-bit value (bit 7:1)
                          which is set to '1' will cause an automatic compare on
                          the corresponding bit of the received address when it
                          is compared to the SlaveAddr_7bit value associated
                          with this mask register. In other words, bits in
                          SlaveAddr_7bit value which are masked are not taken
                          into account in determining an address match
                          */
...
typedef struct {
  ...
  void (*callback)(void); /**< Pointer to Call back function when transmission
                             complete used in interrupt transfer mode */
} I2C_M_SETUP_Type;
