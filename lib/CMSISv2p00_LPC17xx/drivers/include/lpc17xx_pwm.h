...
#define PWM_MCR_INT_ON_MATCH(n)                                                \
  ((uint32_t)(1 << (((n & 0x7) << 1) + (n & 0x07))))
/** reset the PWM when a MATCHn occurs */
#define PWM_MCR_RESET_ON_MATCH(n)                                              \
  ((uint32_t)(1 << (((n & 0x7) << 1) + (n & 0x07) + 1)))
/** stop the PWM when a MATCHn occurs */
#define PWM_MCR_STOP_ON_MATCH(n)                                               \
  ((uint32_t)(1 << (((n & 0x7) << 1) + (n & 0x07) + 2)))
...
#define PWM_CCR_CAP_FALLING(n)                                                 \
  ((uint32_t)(1 << (((n & 0x2) << 1) + (n & 0x1) + 1)))
/** PWM interrupt is generated on a PCAP event */
#define PWM_CCR_INT_ON_CAP(n)                                                  \
  ((uint32_t)(1 << (((n & 0x2) << 1) + (n & 0x1) + 2)))
...
#define PARAM_PWM_INTSTAT(n)                                                   \
  ((n == PWM_INTSTAT_MR0) || (n == PWM_INTSTAT_MR1) ||                         \
   (n == PWM_INTSTAT_MR2) || (n == PWM_INTSTAT_MR3) ||                         \
   (n == PWM_INTSTAT_MR4) || (n == PWM_INTSTAT_MR5) ||                         \
   (n == PWM_INTSTAT_MR6) || (n == PWM_INTSTAT_CAP0) ||                        \
   (n == PWM_INTSTAT_CAP1))
/**
 * @}
 */
...
#define PARAM_PWM_TIMER_PRESCALE(n)                                            \
  ((n == PWM_TIMER_PRESCALE_TICKVAL) || (n == PWM_TIMER_PRESCALE_USVAL))
...
#define PARAM_PWM_COUNTER_INPUTSEL(n)                                          \
  ((n == PWM_COUNTER_PCAP1_0) || (n == PWM_COUNTER_PCAP1_1))
...
#define PARAM_PWM_CHANNEL_EDGE(n)                                              \
  ((n == PWM_CHANNEL_SINGLE_EDGE) || (n == PWM_CHANNEL_DUAL_EDGE))
...
#define PARAM_PWM_MATCH_UPDATE(n)                                              \
  ((n == PWM_MATCH_UPDATE_NOW) || (n == PWM_MATCH_UPDATE_NEXT_RST))
...
typedef enum {
  PWM_INTSTAT_MR0 =
      PWM_IR_PWMMRn(0), /**< Interrupt flag for PWM match channel 0 */
  PWM_INTSTAT_MR1 =
      PWM_IR_PWMMRn(1), /**< Interrupt flag for PWM match channel 1 */
  PWM_INTSTAT_MR2 =
      PWM_IR_PWMMRn(2), /**< Interrupt flag for PWM match channel 2 */
  PWM_INTSTAT_MR3 =
      PWM_IR_PWMMRn(3), /**< Interrupt flag for PWM match channel 3 */
  PWM_INTSTAT_CAP0 =
      PWM_IR_PWMCAPn(0), /**< Interrupt flag for capture input 0 */
  PWM_INTSTAT_CAP1 =
      PWM_IR_PWMCAPn(1), /**< Interrupt flag for capture input 1 */
  PWM_INTSTAT_MR4 =
      PWM_IR_PWMMRn(4), /**< Interrupt flag for PWM match channel 4 */
  PWM_INTSTAT_MR6 =
      PWM_IR_PWMMRn(5), /**< Interrupt flag for PWM match channel 5 */
  PWM_INTSTAT_MR5 =
      PWM_IR_PWMMRn(6) /**< Interrupt flag for PWM match channel 6 */
} PWM_INTSTAT_TYPE;
...
void PWM_PinConfig(LPC_PWM_TypeDef *PWMx, uint8_t PWM_Channel,
...
void PWM_Init(LPC_PWM_TypeDef *PWMx, uint32_t PWMTimerCounterMode,
...
void PWM_ChannelConfig(LPC_PWM_TypeDef *PWMx, uint8_t PWMChannel,
                       uint8_t ModeOption);
void PWM_ChannelCmd(LPC_PWM_TypeDef *PWMx, uint8_t PWMChannel,
