...
#define PARAM_AFMODE_TYPE(n)                                                   \
  ((n == CAN_Normal) || (n == CAN_AccOff) || (n == CAN_AccBP) ||               \
   (n == CAN_eFCAN))
...
#define PARAM_INT_EN_TYPE(n)                                                   \
  ((n == CANINT_RIE) || (n == CANINT_TIE1) || (n == CANINT_EIE) ||             \
   (n == CANINT_DOIE) || (n == CANINT_WUIE) || (n == CANINT_EPIE) ||           \
   (n == CANINT_ALIE) || (n == CANINT_BEIE) || (n == CANINT_IDIE) ||           \
   (n == CANINT_TIE2) || (n == CANINT_TIE3) || (n == CANINT_FCE))
...
typedef struct {
  ...
  uint8_t type;     /**< Remote Frame transmission, should be:
                       ...
                       DLC     field are send from the CANxTDA and CANxTDB registers
