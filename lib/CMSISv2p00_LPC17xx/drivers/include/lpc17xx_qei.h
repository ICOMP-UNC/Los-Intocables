...
#define QEI_IESET_POS0_Int                                                                                             \
    ((uint32_t)(1 << 6)) /**< Set Enable Interrupt Bit Indicates that the position                                     \
                         0 compare value is equal to the current position */
#define QEI_IESET_POS1_Int                                                                                             \
    ((uint32_t)(1 << 7)) /**< Set Enable Interrupt Bit Indicates that the position                                     \
                         1compare value is equal to the current position */
#define QEI_IESET_POS2_Int                                                                                             \
    ((uint32_t)(1 << 8)) /**< Set Enable Interrupt Bit Indicates that the position                                     \
                         2 compare value is equal to the current position */
...
#define QEI_IECLR_REV_Int                                                                                              \
    ((uint32_t)(1 << 9)) /**< Clear Enabled Interrupt Bit Indicates that the index                                     \
                         compare value is equal to the current index count */
