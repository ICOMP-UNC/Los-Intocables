...
#define UART_IIR_INTID_CTI                                                     \
  ((uint32_t)(                                                                 \
      6 << 1)) /*!<Interrupt identification: Character time-out indicator*/
...
#define UART_LSR_THRE                                                          \
  ((uint8_t)(                                                                  \
      1 << 5)) /*!<Line status register: Transmit holding register empty*/
...
#define UART_ICR_PULSEDIV(n)                                                   \
  ((uint32_t)(                                                                 \
      (n & 0x07)                                                               \
      << 3)) /**< PulseDiv - Configures the pulse when FixPulseEn = 1 */
...
#define UART1_RS485CTRL_SEL_DTR                                                \
  ((uint32_t)(                                                                 \
      1 << 3)) /*!< If direction control is enabled                            \
...
#define UART_FIFOLVL_RXFIFOLVL(n)                                              \
  ((uint32_t)(                                                                 \
      n & 0x0F)) /**< Reflects the current level of the UART receiver FIFO */
#define UART_FIFOLVL_TXFIFOLVL(n)                                              \
  ((uint32_t)(                                                                 \
      (n >> 8) &                                                               \
      0x0F)) /**< Reflects the current level of the UART transmitter FIFO */
