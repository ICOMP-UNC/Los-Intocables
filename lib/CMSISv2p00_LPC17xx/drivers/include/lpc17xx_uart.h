...
#define UART_RBR_MASKBIT                                                       \
  ((uint8_t)0xFF) /*!< UART Received Buffer mask bit (8 bits) */
...
/*********************************************************************/ /**
                                                                         ...
                                                                         *Register
                                                                         **********************************************************************/
#define UART_THR_MASKBIT                                                       \
  ((uint8_t)0xFF) /*!< UART Transmit Holding mask bit (8 bits) */
...
#define UART_LOAD_DLL(div)                                                     \
  ((div) & 0xFF) /**< Macro for loading least significant halfs of divisors */
...
#define UART_LOAD_DLM(div)                                                     \
  (((div) >> 8) &                                                              \
   0xFF) /**< Macro for loading most significant halfs of divisors */
...
#define UART_IER_RLSINT_EN                                                     \
  ((uint32_t)(1 << 2)) /*!< RX line status interrupt enable*/
#define UART1_IER_MSINT_EN                                                     \
  ((uint32_t)(1 << 3)) /*!< Modem status interrupt enable */
#define UART1_IER_CTSINT_EN                                                    \
  ((uint32_t)(1 << 7)) /*!< CTS1 signal transition interrupt enable */
#define UART_IER_ABEOINT_EN                                                    \
  ((uint32_t)(1 << 8)) /*!< Enables the end of auto-baud interrupt */
#define UART_IER_ABTOINT_EN                                                    \
  ((uint32_t)(1 << 9)) /*!< Enables the auto-baud time-out interrupt */
#define UART_IER_BITMASK                                                       \
  ((uint32_t)(0x307)) /*!< UART interrupt enable register bit mask */
#define UART1_IER_BITMASK                                                      \
  ((uint32_t)(0x38F)) /*!< UART1 interrupt enable register bit mask */
...
/*********************************************************************/ /**
                                                                         ...
                                                                         *register
                                                                         **********************************************************************/
#define UART_IIR_INTSTAT_PEND                                                  \
  ((uint32_t)(1 << 0)) /*!<Interrupt Status - Active low */
#define UART_IIR_INTID_RLS                                                     \
  ((uint32_t)(3 << 1)) /*!<Interrupt identification: Receive line status*/
#define UART_IIR_INTID_RDA                                                     \
  ((uint32_t)(2 << 1)) /*!<Interrupt identification: Receive data available*/
#define UART_IIR_INTID_CTI                                                     \
  ((uint32_t)(6 << 1)) /*!<Interrupt identification: Character time-out        \
                          indicator*/
#define UART_IIR_INTID_THRE                                                    \
  ((uint32_t)(1 << 1)) /*!<Interrupt identification: THRE interrupt*/
#define UART1_IIR_INTID_MODEM                                                  \
  ((uint32_t)(0 << 1)) /*!<Interrupt identification: Modem interrupt*/
#define UART_IIR_INTID_MASK                                                    \
  ((uint32_t)(7 << 1)) /*!<Interrupt identification: Interrupt ID mask */
#define UART_IIR_FIFO_EN                                                       \
  ((uint32_t)(3 << 6)) /*!<These bits are equivalent to UnFCR[0] */
#define UART_IIR_ABEO_INT                                                      \
  ((uint32_t)(1 << 8)) /*!< End of auto-baud interrupt */
#define UART_IIR_ABTO_INT                                                      \
  ((uint32_t)(1 << 9)) /*!< Auto-baud time-out interrupt */
#define UART_IIR_BITMASK                                                       \
  ((uint32_t)(0x3CF)) /*!< UART interrupt identification register bit mask */
...
#define UART_FCR_TRG_LEV1                                                      \
  ((uint8_t)(1 << 6)) /*!< UART FIFO trigger level 1: 4 character */
#define UART_FCR_TRG_LEV2                                                      \
  ((uint8_t)(2 << 6)) /*!< UART FIFO trigger level 2: 8 character */
#define UART_FCR_TRG_LEV3                                                      \
  ((uint8_t)(3 << 6)) /*!< UART FIFO trigger level 3: 14 character */
...
#define UART_LCR_PARITY_F_0                                                    \
  ((uint8_t)(3 << 4)) /*!< UART force 0 stick parity */
#define UART_LCR_BREAK_EN                                                      \
  ((uint8_t)(1 << 6)) /*!< UART Transmission Break enable */
#define UART_LCR_DLAB_EN                                                       \
  ((uint8_t)(1 << 7)) /*!< UART Divisor Latches Access bit enable */
...
/*********************************************************************/ /**
                                                                         ...
                                                                         *Register
                                                                         **********************************************************************/
#define UART1_MCR_DTR_CTRL                                                     \
  ((uint8_t)(1 << 0)) /*!< Source for modem output pin DTR */
#define UART1_MCR_RTS_CTRL                                                     \
  ((uint8_t)(1 << 1)) /*!< Source for modem output pin RTS */
#define UART1_MCR_LOOPB_EN ((uint8_t)(1 << 4)) /*!< Loop back mode select */
#define UART1_MCR_AUTO_RTS_EN                                                  \
  ((uint8_t)(1 << 6)) /*!< Enable Auto RTS flow-control */
#define UART1_MCR_AUTO_CTS_EN                                                  \
  ((uint8_t)(1 << 7)) /*!< Enable Auto CTS flow-control */
...
#define UART_LSR_BI                                                            \
  ((uint8_t)(1 << 4)) /*!<Line status register: Break interrupt*/
#define UART_LSR_THRE                                                          \
  ((uint8_t)(1 << 5)) /*!<Line status register: Transmit holding register      \
                         empty*/
#define UART_LSR_TEMT                                                          \
  ((uint8_t)(1 << 6)) /*!<Line status register: Transmitter empty*/
...
/*********************************************************************/ /**
                                                                         ...
                                                                         *register
                                                                         **********************************************************************/
#define UART1_MSR_DELTA_CTS                                                    \
  ((uint8_t)(1 << 0)) /*!< Set upon state change of input CTS */
#define UART1_MSR_DELTA_DSR                                                    \
  ((uint8_t)(1 << 1)) /*!< Set upon state change of input DSR */
#define UART1_MSR_LO2HI_RI                                                     \
...
#define UART_ACR_AUTO_RESTART                                                  \
  ((uint32_t)(1 << 2)) /**< UART Auto baudrate restart */
#define UART_ACR_ABEOINT_CLR                                                   \
  ((uint32_t)(1 << 8)) /**< UART End of auto-baud interrupt clear */
#define UART_ACR_ABTOINT_CLR                                                   \
  ((uint32_t)(1 << 9)) /**< UART Auto-baud time-out interrupt clear */
#define UART_ACR_BITMASK                                                       \
  ((uint32_t)(0x307)) /**< UART Auto Baudrate register bit mask */
...
#define UART_ICR_PULSEDIV(n)                                                   \
  ((uint32_t)((n & 0x07) << 3)) /**< PulseDiv - Configures the pulse when      \
                                   FixPulseEn = 1 */
...
#define UART_FDR_DIVADDVAL(n)                                                  \
  ((uint32_t)(n & 0x0F)) /**< Baud-rate generation pre-scaler divisor */
#define UART_FDR_MULVAL(n)                                                     \
  ((uint32_t)((n << 4) & 0xF0)) /**< Baud-rate pre-scaler multiplier value */
#define UART_FDR_BITMASK                                                       \
  ((uint32_t)(0xFF)) /**< UART Fractional Divider register bit mask */
...
#define UART_TER_BITMASK                                                       \
  ((uint8_t)(0x80)) /**< UART Transmit Enable Register bit mask */
...
#define UART1_RS485CTRL_NMM_EN                                                 \
  ((uint32_t)(1 << 0)) /*!< RS-485/EIA-485 Normal Multi-drop Mode (NMM)        \
                       is disabled */
#define UART1_RS485CTRL_RX_DIS                                                 \
  ((uint32_t)(1 << 1)) /*!< The receiver is disabled */
#define UART1_RS485CTRL_AADEN                                                  \
  ((uint32_t)(1 << 2)) /*!< Auto Address Detect (AAD) is enabled */
#define UART1_RS485CTRL_SEL_DTR                                                \
  ((uint32_t)(1                                                                \
              << 3)) /*!< If direction control is enabled                      \
                     (bit DCTRL = 1), pin DTR is used for direction control */
#define UART1_RS485CTRL_DCTRL_EN                                               \
  ((uint32_t)(1 << 4)) /*!< Enable Auto Direction Control */
...
/*********************************************************************/ /**
                                                                         ...
                                                                         *register
                                                                         **********************************************************************/
#define UART_FIFOLVL_RXFIFOLVL(n)                                              \
  ((uint32_t)(n & 0x0F)) /**< Reflects the current level of the UART receiver  \
                            FIFO */
#define UART_FIFOLVL_TXFIFOLVL(n)                                              \
  ((uint32_t)((n >> 8) & 0x0F)) /**< Reflects the current level of the UART    \
                                   transmitter FIFO */
#define UART_FIFOLVL_BITMASK                                                   \
  ((uint32_t)(0x0F0F)) /**< UART FIFO Level Register bit mask */
...
/** Macro to check the input UART1_INTCFG parameters - expansion input parameter
 * for UART1 */
...
typedef enum {
  UART_LINESTAT_RDR =
      UART_LSR_RDR,               /*!<Line status register: Receive data ready*/
  ...
  UART_LINESTAT_THRE =
      UART_LSR_THRE, /*!<Line status register: Transmit holding register empty*/
  UART_LINESTAT_TEMT =
      UART_LSR_TEMT, /*!<Line status register: Transmitter empty*/
...
typedef enum {
  UART_AUTOBAUD_INTSTAT_ABEO =
      UART_IIR_ABEO_INT, /**< UART End of auto-baud interrupt  */
  UART_AUTOBAUD_INTSTAT_ABTO =
      UART_IIR_ABTO_INT /**< UART Auto-baud time-out interrupt  */
} UART_ABEO_Type;
...
typedef enum {
  UART1_MODEM_STAT_DELTA_CTS =
      UART1_MSR_DELTA_CTS, /*!< Set upon state change of input CTS */
  UART1_MODEM_STAT_DELTA_DSR =
      UART1_MSR_DELTA_DSR, /*!< Set upon state change of input DSR */
  UART1_MODEM_STAT_LO2HI_RI =
      UART1_MSR_LO2HI_RI, /*!< Set upon low to high transition of input RI */
  UART1_MODEM_STAT_DELTA_DCD =
      UART1_MSR_DELTA_DCD, /*!< Set upon state change of input DCD */
...
typedef struct {
  ...
  SetState
      DirCtrlPol_Level;   /*!< Polarity of the direction control signal on
                          the RTS (or DTR) pin:
                        ...
                        */
  uint8_t MatchAddrValue; /*!< address match value for RS-485/EIA-485 mode,
                             8-bit long */
  uint8_t
...
uint32_t UART_RS485SendData(LPC_UART1_TypeDef *UARTx, uint8_t *pData,
                            uint32_t size);
