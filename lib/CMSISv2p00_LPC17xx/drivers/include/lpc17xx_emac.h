...
#define EMAC_MAC1_RES_MCS_TX                                                   \
  0x00000200 /**< Reset MAC TX Control Sublayer     */
#define EMAC_MAC1_RES_RX 0x00000400 /**< Reset RX Logic                    */
#define EMAC_MAC1_RES_MCS_RX                                                   \
  0x00000800 /**< Reset MAC RX Control Sublayer     */
...
#define EMAC_MAC2_FRM_LEN_CHK                                                  \
  0x00000002 /**< Frame Length Checking             */
...
#define EMAC_MAC2_VLAN_PAD_EN                                                  \
  0x00000040 /**< VLAN Pad Enable                   */
#define EMAC_MAC2_ADET_PAD_EN                                                  \
  0x00000080 /**< Auto Detect Pad Enable            */
#define EMAC_MAC2_PPREAM_ENF                                                   \
  0x00000100 /**< Pure Preamble Enforcement         */
#define EMAC_MAC2_LPREAM_ENF                                                   \
  0x00000200 /**< Long Preamble Enforcement         */
#define EMAC_MAC2_NO_BACKOFF                                                   \
  0x00001000 /**< No Backoff Algorithm              */
#define EMAC_MAC2_BACK_PRESSURE                                                \
  0x00002000 /**< Backoff Presurre / No Backoff     */
#define EMAC_MAC2_EXCESS_DEF                                                   \
  0x00004000 /**< Excess Defer                      */
...
#define EMAC_TEST_SHCUT_PQUANTA                                                \
  0x00000001 /**< Shortcut Pause Quanta             */
...
#define EMAC_MCFG_SUPP_PREAM                                                   \
  0x00000002 /**< Suppress Preamble                 */
#define EMAC_MCFG_CLK_SEL(n)                                                   \
  ((n & 0x0F) << 2) /**< Clock Select Field                 */
...
/*********************************************************************/ /**
                                                                         ...
                                                                         *Register
                                                                         **********************************************************************/
#define EMAC_MADR_REG_ADR(n)                                                   \
  (n & 0x1F) /**< MII Register Address field         */
#define EMAC_MADR_PHY_ADR(n)                                                   \
  ((n & 0x1F) << 8) /**< PHY Address Field                  */
...
/*********************************************************************/ /**
                                                                         ...
                                                                         *Register
                                                                         **********************************************************************/
#define EMAC_MWTD_DATA(n)                                                      \
  (n & 0xFFFF) /**< Data field for MMI Management Write Data register */
...
/*********************************************************************/ /**
                                                                         ...
                                                                         *Register
                                                                         **********************************************************************/
#define EMAC_MRDD_DATA(n)                                                      \
  (n & 0xFFFF) /**< Data field for MMI Management Read Data register */
...
#define EMAC_CR_PASS_RUNT_FRM                                                  \
  0x00000040 /**< Pass Runt Frames                  */
#define EMAC_CR_PASS_RX_FILT                                                   \
  0x00000080 /**< Pass RX Filter                    */
#define EMAC_CR_TX_FLOW_CTRL                                                   \
  0x00000100 /**< TX Flow Control                   */
...
#define EMAC_TSV0_LEN_CHKERR                                                   \
  0x00000002 /**< Length Check Error                */
#define EMAC_TSV0_LEN_OUTRNG                                                   \
  0x00000004 /**< Length Out of Range               */
...
#define EMAC_TSV0_BACK_PRESS                                                   \
  0x40000000 /**< Backpressure Method Applied       */
...
#define EMAC_RSV_PKT_IGNORED                                                   \
  0x00010000 /**< Packet Previously Ignored         */
...
/*********************************************************************/ /**
                                                                         ...
                                                                         *Register
                                                                         **********************************************************************/
#define EMAC_FCC_MIRR_CNT(n)                                                   \
  (n & 0xFFFF) /**< Mirror Counter                    */
#define EMAC_FCC_PAUSE_TIM(n)                                                  \
  ((n & 0xFFFF) << 16) /**< Pause Timer                       */
...
/*********************************************************************/ /**
                                                                         ...
                                                                         *Register
                                                                         **********************************************************************/
#define EMAC_FCS_MIRR_CNT(n)                                                   \
  (n & 0xFFFF) /**< Mirror Counter Current            */
...
#define EMAC_RFC_UCAST_HASH_EN                                                 \
  0x00000008 /**< Accept Unicast Hash Filter Frames */
#define EMAC_RFC_MCAST_HASH_EN                                                 \
  0x00000010 /**< Accept Multicast Hash Filter Fram.*/
#define EMAC_RFC_PERFECT_EN 0x00000020 /**< Accept Perfect Match Enable */
#define EMAC_RFC_MAGP_WOL_EN                                                   \
  0x00001000 /**< Magic Packet Filter WoL Enable    */
#define EMAC_RFC_PFILT_WOL_EN                                                  \
  0x00002000 /**< Perfect Filter WoL Enable         */
...
#define EMAC_WOL_BITMASK                                                       \
  0x01BF /**< Receive Filter WoL Status/Clear bitmasl value */
...
#define EMAC_RINFO_CTRL_FRAME                                                  \
  0x00040000 /**< Control Frame                     */
#define EMAC_RINFO_VLAN 0x00080000 /**< VLAN Frame                        */
#define EMAC_RINFO_FAIL_FILT                                                   \
  0x00100000 /**< RX Filter Failed                  */
...
#define EMAC_RINFO_RANGE_ERR                                                   \
  0x04000000 /**< Range Error (exceeded max. size)  */
#define EMAC_RINFO_ALIGN_ERR                                                   \
  0x08000000 /**< Alignment Error                   */
#define EMAC_RINFO_OVERRUN 0x10000000 /**< Receive overrun */
#define EMAC_RINFO_NO_DESCR 0x20000000 /**< No new Descriptor available */
#define EMAC_RINFO_LAST_FLAG                                                   \
  0x40000000 /**< Last Fragment in Frame            */
...
#define EMAC_TINFO_EXCESS_DEF                                                  \
  0x04000000 /**< Excessive Deferral                */
#define EMAC_TINFO_EXCESS_COL                                                  \
  0x08000000 /**< Excessive Collision               */
 ...
 */
typedef struct {
  uint32_t Mode; /**< Supported EMAC PHY device speed, should be one of the
                 following:
                 - EMAC_MODE_AUTO
                 - EMAC_MODE_10M_FULL
                 - EMAC_MODE_10M_HALF
                 ...
                 - EMAC_MODE_100M_HALF
                 */
  uint8_t *pbEMAC_Addr; /**< Pointer to EMAC Station address that contains
                        6-bytes of MAC address, it must be sorted in order
                        (bEMAC_Addr[0]..[5])
                        */
} EMAC_CFG_Type;
