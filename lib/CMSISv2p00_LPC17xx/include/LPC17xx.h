...
#define __NVIC_PRIO_BITS                                                       \
  5 /*!< Number of Bits used for Priority Levels          */
...
/** @brief  Universal Asynchronous Receiver Transmitter (UART) register
...
/** @brief  Universal Asynchronous Receiver Transmitter 0 (UART0) register
 * structure definition */
typedef struct {
  union {
    __I uint8_t RBR;
...
/** @brief  Universal Asynchronous Receiver Transmitter 1 (UART1) register
 * structure definition */
typedef struct {
  union {
    __I uint8_t RBR;
...
/** @brief  Motor Control Pulse-Width Modulation (MCPWM) register structure
 * definition */
typedef struct {
  __I uint32_t MCCON;
...
/** @brief  Controller Area Network Central (CANCR) register structure
 * definition */
...
/** @brief  Controller Area Network Controller (CAN) register structure
 * definition */
...
/** @brief  General Purpose Direct Memory Access (GPDMA) register structure
 * definition */
...
/** @brief  General Purpose Direct Memory Access Channel (GPDMACH) register
 * structure definition */
...
/** @brief  Ethernet Media Access Controller (EMAC) register structure
 * definition */
typedef struct {
